...
;; The original levuen theme is authored by Fabrice Niessen and is
;; available here: https://github.com/fniessen/emacs-leuven-theme
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(helm-ff-directory ((,class (:foreground "blue" :background "#eeeeee"))))
   `(helm-ff-dotted-directory ((,class (:foreground "#0066CC" :background "#eeeeee"))))
   ...
   `(org-default ((,class (:foreground "#555555" :background "#FFFFFF"))))
